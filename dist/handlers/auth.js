...
exports.registerUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, userAlreadyExists, response, hashedPassword, newUser, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, user_1.User.create({ username: username, password: hashedPassword })];
            case 4:
                newUser = _b.sent();
                response = {
                    message: null,
