...
export const TestProvider = AuthContext.Provider;
...
export const AuthContextProvider: React.FC = ({ children }) => {
  ...
  const refreshUserQuizzes = () => setRefreshSwitch(prevState => !prevState);

  useEffect(() => {
    if (currentUser) {
      uploadUserQuizzes();
    }
  }, [currentUser, uploadUserQuizzes, refreshSwitch]);
